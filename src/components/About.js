            ...
            <h2>About Me</h2>
                <div className="about-words">       
                    ...
                    <p className="about-info" id="contact-info">
                        I graduated from <a className="text-link" href={raddy} target="_blank" rel="noreferrer">Radford University</a> in 2018 with a Bachelor's degree in Computer Science and Technology, with a concentration in Database Design, as well as an Undergraduate Information Security Certificate recognized by the NSA.
                </p>
                </div>
            </Zoom>
            <br />
