            ...
            <h2>About Me</h2>
                <div className="about-words">       
                    <p className="about-info" >
                        My name is <a className="text-link" href="https://linkedin.com/in/jakebarber1996" target="_blank" rel="noreferrer">Jake Barber</a> and I am an experienced Software Developer and IT Proffesional, specializing in blockchain technology.
                    </p>
