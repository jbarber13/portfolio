...
const pos = "https://en.wikipedia.org/wiki/Proof_of_stake"
            ...
            <div className="blockchain-words">
                ...
                <Pulse delay={400}>
                    <div className="blockchain-words-paragraph-left">
                        ...
                        <p>
                        Ethereum is an additional and separate blockchain network from Bitcoin, and it operates in an entirely different way. Ethereum allows for a decentralized peer-to-peer exchange of value (using its native token "Ether") in a similar way to Bitcoin (using proof-of-work) as of this time, though the Ethereum network is moving to <a className="text-link" href={pos} target="_blank" rel="noreferrer">proof-of-stake</a> in the near future. In addition to this, Ethereum has the ability to act as a decentralized <a className="text-link" href={stateMachine} target="_blank" rel="noreferrer">state machine</a>. This is known as the Ethereum Virtual Machine (<a className="text-link" href={evm} target="_blank" rel="noreferrer">EVM</a>). In this way, the state of the Ethereum network not only includes accounts and balances (like Bitcoin), but also includes a machine state which can execute <a className="text-link" href={machineCode} target="_blank" rel="noreferrer">machine code</a>. This code can be made into complicated software allowing for a complex exchange of value to occur. This software is known as a <a className="text-link" href={smartContract} target="_blank" rel="noreferrer">Smart Contract</a>.
                        </p>
